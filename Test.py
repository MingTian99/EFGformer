...
parser.add_argument('--data_path', type=str, default='D:/1Single_Image_Derain/data/Real_World_rain2/')
parser.add_argument('--save_path', type=str, default='img_SwinIR_Real_image')
parser.add_argument('--eval_workers', type=int, default=1)
parser.add_argument('--weights', type=str, default='NAFNet_Rain200H_FFT_1500_GELU/net_latest.pth')

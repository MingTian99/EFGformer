...
# parser.add_argument('--generated_images_path', default='D:/1Single_Image_Derain/data/Rain100H_/val/label1', help='Generated / Restored / Recovered images -path')
# # parser.add_argument('--generated_images_path', default='img_Restormer_FFT_thick', help='Generated / Restored / Recovered images -path')
# parser.add_argument('--target_path', default='D:/1Single_Image_Derain/Demo/LSHA2_deraining/img_LSH_Rain100H_NHash1_111111', help='Ground-truth -path')

parser.add_argument('--generated_images_path', default='D:/1Single_Image_Derain/Demo/LSHA2_deraining/img_LSH_Rain100H_NHash1', help='Generated / Restored / Recovered images -path')
# parser.add_argument('--generated_images_path', default='img_Restormer_FFT_thick', help='Generated / Restored / Recovered images -path')
parser.add_argument('--target_path', default='D:/1Single_Image_Derain/data/Rain200/test/target', help='Ground-truth -path')
